...
/emoji days <日数>     # 指定期間で絵文字分析を実行
/emoji months <月数>   # 指定期間で絵文字分析を実行

# ワーストランキング
/emoji worst          # デフォルト期間でワーストランキングを実行
/emoji worst-days <日数>   # 指定期間でワーストランキングを実行
/emoji worst-months <月数> # 指定期間でワーストランキングを実行

# その他
/emoji test           # テスト分析（1日分）
/emoji debug          # デバッグ情報表示
/emoji help           # ヘルプ表示
```
